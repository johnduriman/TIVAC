...
int main(void)
{
    ...
    //Calculate sine value for each of the 1000 values of the angle and place them in the data array
    while(i32DataCount < SERIES_LENGTH)
    {
        gSeriesData[i32DataCount] = sinf(50 * fRadians * i32DataCount) + 0.5 * cosf(200 * fRadians * i32DataCount);  //Calculation for each angle
